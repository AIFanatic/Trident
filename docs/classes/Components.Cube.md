[trident](../README.md) / [Exports](../modules.md) / [Components](../modules/Components.md) / Cube
...
- [constructor](Components.Cube.md#constructor)

### Properties

- [classname](Components.Cube.md#classname)
- [classtype](Components.Cube.md#classtype)
- [gameObject](Components.Cube.md#gameobject)
- [hasStarted](Components.Cube.md#hasstarted)
- [name](Components.Cube.md#name)
- [transform](Components.Cube.md#transform)
- [uuid](Components.Cube.md#uuid)

### Methods

- [Destroy](Components.Cube.md#destroy)
- [FixedUpdate](Components.Cube.md#fixedupdate)
- [LateUpdate](Components.Cube.md#lateupdate)
- [OnDisable](Components.Cube.md#ondisable)
- [OnDrawGizmos](Components.Cube.md#ondrawgizmos)
- [OnEnable](Components.Cube.md#onenable)
- [OnGizmosDisabled](Components.Cube.md#ongizmosdisabled)
- [OnGizmosEnabled](Components.Cube.md#ongizmosenabled)
- [Start](Components.Cube.md#start)
- [Stop](Components.Cube.md#stop)
- [Update](Components.Cube.md#update)

## Constructors

### constructor

• **new Cube**(`gameObject`, `transform`)
...
[components/Cube.ts:6](https://github.com/AIFanatic/Trident/blob/e986bc9/src/components/Cube.ts#L6)
