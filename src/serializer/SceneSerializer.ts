...
export class SceneSerializer {
    ...
    static SerializeComponentProperty(component: Component, property: string, checkCustomTypeOnly = false): IComponentPropertySerialized {
    ...
    static SerializeComponent(component: Component): IComponentSerialized {
        ...
        let componentSerialized: IComponentSerialized = {
            uuid: component.uuid,
    ...
    static SerializeGameObject(gameObject: GameObject): IGameObjectSerialized {
        let gameObjectSerialized: IGameObjectSerialized = {
        ...
        for (let component of gameObject.components) {
            const componentCast = component as Component;
            if (componentCast.hideFlags == HideFlags.HideAndDontSave) continue;
